      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="p-2 rounded-lg bg-gradient-to-r from-teal-600 to-indigo-600 text-white">
                <HiCode className="text-xl" />
              </div>
              <span className="text-xl font-bold font-display">Sandeep Kumar</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#skills" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">
                  Skills
                </a>
              </li>
              <li>
                <a href="#projects" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">
                  Projects
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-navy-800 hover:bg-teal-600 flex items-center justify-center transition-all duration-300"
                aria-label="LinkedIn"
              >
        ...
        <div className="border-t border-navy-800 pt-8 text-center">
          ...
          <p className="text-gray-500 text-xs">
            Built with <span className="text-teal-400">Next.js</span> and <span className="text-teal-400">Tailwind CSS</span>
          </p>
        </div>
      </div>
    </footer>
